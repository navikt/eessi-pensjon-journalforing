...
class OppgaveRoutingService(private val norg2Service: Norg2Service) {
    ...
    fun route(navBruker: String? = null,
        ...
        val tildeltEnhet = hentNorg2Enhet(navBruker, geografiskTilknytning, landkode, bucType, diskresjonskode) ?: bestemTildeltEnhet(navBruker, landkode, bucType, fodselsDato, ytelseType)
    ...
    private fun bestemTildeltEnhet(navBruker: String?, landkode: String?, bucType: BucType?, fodselsDato: LocalDate, ytelseType: OppgaveRoutingModel.YtelseType?): Enhet {
