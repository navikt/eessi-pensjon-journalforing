...
internal class FBBuc01IntegrasjonsTest : MottattOgSendtIntegrationBase() {
    ...
    fun `Når en sedSendt hendelse med en foreldre blir konsumert så skal den ikke opprette oppgave`() {
        ...
        initAndRunContainer().apply {
            send(SED_SENDT_TOPIC, javaClass.getResource("/eux/hendelser/FB_BUC_01_F001.json").readText())
