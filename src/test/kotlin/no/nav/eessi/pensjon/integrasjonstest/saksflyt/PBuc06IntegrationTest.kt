...
internal class PBuc06IntegrationTest : JournalforingTestBase() {
    ...
    fun `Gitt en P6000 med enkeltkrav type ufore eller pensjon så skal tema bli deretter`(alder: Int, kravType: String, tema: String) {
        ...
        val actual = hentTemaService.hentTema(sedHendelse, alder, 1, null, sed)
    ...
    fun `Gitt en P5000 med enkeltkrav krav med type ufore eller pensjon så skal tema bli deretter`(alder: Int, kravType: String, tema: String) {
    ...
    fun `Gitt en P7000 med enkeltkrav krav med type ufore eller pensjon s å skal tema bli deretter`(alder: Int, penType: String, tema: String) {
    ...
    fun `Gitt en P10000 med pensjonstype ufore eller pensjon så skal tema bli deretter`(alder: Int, penType: String, tema: String) {
