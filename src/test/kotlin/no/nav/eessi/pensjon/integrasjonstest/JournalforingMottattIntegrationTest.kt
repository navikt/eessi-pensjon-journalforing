...
class JournalforingMottattIntegrationTest {
    ...
    private fun produserSedHendelser(sedMottattProducerTemplate: KafkaTemplate<Int, String>) {
        ...
        sedMottattProducerTemplate.sendDefault(TestUtils.getResource("eux/hendelser/FB_BUC_01_F001.json"))

        // Seder 1 i H_BUC_07 SED til Kafka
        sedMottattProducerTemplate.sendDefault(TestUtils.getResource("eux/hendelser/H_BUC_07_H070.json"))

        // Sender Pensjon SED til Kafka
        sedMottattProducerTemplate.sendDefault(TestUtils.getResource("eux/hendelser/P_BUC_01_P2000.json"))
        sedMottattProducerTemplate.sendDefault(TestUtils.getResource("eux/hendelser/P_BUC_03_P2200.json"))
        sedMottattProducerTemplate.sendDefault(TestUtils.getResource("eux/hendelser/P_BUC_05_X008.json"))
        sedMottattProducerTemplate.sendDefault(TestUtils.getResource("eux/hendelser/P_BUC_01_P2000_MedUgyldigVedlegg.json"))

        // Sender Sed med ugyldig FNR
        sedMottattProducerTemplate.sendDefault(TestUtils.getResource("eux/hendelser/P_BUC_01_P2000_ugyldigFNR.json"))

        sedMottattProducerTemplate.sendDefault(TestUtils.getResource("eux/hendelser/R_BUC_02_R005.json"))
        ...
        init {
            ...
            mockServer.`when`(
                    ...
                    .respond(HttpResponse.response()
                            .withHeader(Header("Content-Type", "application/json; charset=utf-8"))
                            .withStatusCode(HttpStatusCode.OK_200.code())
                            .withBody(TestUtils.getResource("sed/R005-alderpensjon-NAV.json"))
                    )
            ...
            mockServer.`when`(
                    ...
                    .respond(HttpResponse.response()
                            .withHeader(Header("Content-Type", "application/json; charset=utf-8"))
                            .withStatusCode(HttpStatusCode.OK_200.code())
                            .withBody(TestUtils.getResource("sed/R_BUC_02_H070-NAV.json"))
                    )
            ...
            mockServer.`when`(
                    ...
                    .respond(HttpResponse.response()
                            .withHeader(Header("Content-Type", "application/json; charset=utf-8"))
                            .withStatusCode(HttpStatusCode.OK_200.code())
                            .withBody(TestUtils.getResource("fagmodul/alldocumentsidsH_BUC_07.json"))
                    )
