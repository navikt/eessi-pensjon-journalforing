...
internal class JournalforingServiceTest : JournalforingServiceBase() {
    ...
    fun `gitt det er en P_BUC_05 ytelseype IKKE er UFOREP så skal det settes tema PEN`() {
        ...
        val resultatALDER = hentTemaService.hentTema(mockedSedhendelse, alder = SLAPP_SKILPADDE.getAge(), 1, saksInfoSamlet(ALDER), SED(type = SedType.P8000))
    ...
    fun `gitt det er en P_BUC_06 kravtypen er UFOREP så skal det settes tema UFO`() {
        ...
        val resultatALDERP8000 = hentTemaService.hentTema(mockedSedhendelse, alder = SLAPP_SKILPADDE.getAge(), 1, saksInfoSamlet(ALDER), SED(type = SedType.P8000))
