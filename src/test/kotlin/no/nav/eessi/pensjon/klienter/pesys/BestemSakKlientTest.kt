...
class BestemSakKlientTest {
    ...
    @Test
    fun `Gitt en P_BUC_02 med en kjent aktørId og toggle er på skal det returneres et saksnummer`(){
        ...
        assertEquals("22873157", bestemSakKlient.hentSakId("12345678901", BucType.P_BUC_02, null))
