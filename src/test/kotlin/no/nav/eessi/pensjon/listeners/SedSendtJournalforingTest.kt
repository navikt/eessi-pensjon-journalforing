...
/*
        Assertions.assertEquals(ID_OG_FORDELING, actualRequest.journalfoerendeEnhet)
        Assertions.assertEquals(ID_OG_FORDELING, actualRequestOppgave.tildeltEnhetsnr)
*/
